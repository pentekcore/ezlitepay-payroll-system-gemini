/*
  ...
  1. Database Changes
    - Convert profiles.role column from text to app_role enum
    - Update get_user_role function to return proper app_role type
    - Recreate all RLS policies that depend on the function

  2. Security
    - Maintain all existing RLS policies
    - Ensure proper type casting throughout
*/
...
-- Now set the default value for the role column after type conversion
ALTER TABLE profiles 
