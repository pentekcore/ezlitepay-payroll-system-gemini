/*
  ...
  2. Security
    ...
    - Add policies for admins/managers to manage payrolls
    - Add policy for authenticated users to view payrolls

  3. Constraints and Indexes
    - Foreign key to employees table
    - Unique constraint to prevent duplicate payslips per period
    - Performance indexes on employee_id, pay_period, and created_at
