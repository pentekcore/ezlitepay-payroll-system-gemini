...
const DashboardPage: React.FC = () => {
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      ...
      setError("Failed to load dashboard data. You might be offline or experiencing network issues. Please try refreshing the page.");
    } finally {
      setIsLoading(false);
    }
  }, []);
  ...
  if (error) {
    return (
      <div className="container mx-auto">
        ...
        <div className="text-center p-10 bg-red-50 text-red-700 rounded-lg shadow border border-red-200">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto mb-3 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-card">
          ...
          {isLoading ? ( // This specific isLoading might be redundant if page-level isLoading is handled
